...
const FavouriteHyperlinks = () => {
    const { darkMode } = useContext(DarkModeContext); // Destructure darkMode from contexta
    ...
    return (
        <div className={`p-1  ${darkMode ? 'dark dark:bg-black' : 'bg-gradient-to-b from-color2 via-color2 to-color2'}`}>

            <div className='pt-4 flex flex-row items-center justify-between'>
                <div className='w-3/5 relative'>
                    <h1 className=" text-xl lg:text-3xl font-font6 font-extrabold text-black dark:text-color1 text-center lg:text-start ml-3 mb-3 lg:mb-0 lg:ml-24 p-1 lg:p-4 rounded-2xl">Frequently Used Hosts</h1>
                </div>
...
export default FavouriteHyperlinks;
