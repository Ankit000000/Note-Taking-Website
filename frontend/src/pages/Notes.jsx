...
const Notes = () => {
    ...
    return (
        <div className={`dark:bg-black ${darkMode ? 'dark bg-black' : 'bg-color6'}`}>

            <div className='pt-8 flex flex-row items-center justify-between mb-4'>
                <div className='w-3/5'>
                    <h1 className=" text-xl lg:text-3xl font-font4 font-extrabold text-color1 text-center lg:text-start lg:ml-24 relative z-10">Document Every Detail</h1>
                </div>
            ...
            <div className='w-full h-56 bg-transparent'></div>
